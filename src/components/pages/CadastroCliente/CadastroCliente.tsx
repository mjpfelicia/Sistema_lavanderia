...
const CadastroCliente = ({ cliente }: CadastroCliente) => {
        ...
        <div className="container-fluid vh-100 d-flex flex-column justify-content-center align-items-center bg-white">
            <form onSubmit={handleSubmit} className="p-4">
                ...
                <div className="form-group formGroup mb-3">
                    ...
                    <input type="text" className="form-control formGroupName"
                        name="nome"
                        value={formData.nome}
                ...
                <div className="form-group formGroup mb-3">
                    ...
                    <input type="tel" maxLength={14} className="form-control formGroupTelefone"
                        name="telefone"
                ...
                <div className="form-group formGroup mb-3">
                    <label>Email</label>
                    <input type="email"className="form-control formGroupEmail"
                        name="email"
                ...
                <div className="form-group formGroup mb-3">
                    <label>Número</label>
                    <input type="text" className="form-control formGroupNumero"
                        name="numero"
                ...
                <div className="form-group formGroup mb-3">
                    ...
                    <input type="text" className="form-control formGroupComplemento"
                        name="complemento"
                ...
                <div className="form-group formGroup mb-3">
                    <label>CEP</label>
                    <input type="text" className="form-control formGroupCep"
                        name="cep"
                        value={formData.cep}
                        onChange={handleChange}
                    />
                ...
                <div className="form-group formGroup mb-3">
                    <label>Estado</label>
                    <input type="text" className="form-control formControlEstado"
                        name="estado"
                ...
                <div className="form-group formGroup mb-3">
                    <label>Bairro</label>
                    <input type="text" className="form-control formControlBairro"
                        name="bairro"
            ...
            <ul className="list-group w-100 mt-4">
                {lista.map((item, index) => (
                    <li key={index} className="list-group-item">
                        {item.nome} - {item.telefone} - {item.email} - {item.endereco}, {item.bairro}, {item.cep}                    </li>
                ))}
            </ul>
        </div>
    );
