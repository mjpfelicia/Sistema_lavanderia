        ...
        <div className="container-fluid vh-100 d-flex flex-column justify-content-center align-items-center">
            <form onSubmit={handleSubmit} className="p-4 formCadastro">
                ...
                <div className="form-group formGroup mb-3">
                    ...
                    <input type="text" className="form-control formGroupName" name="nome"
                        value={formData.nome}
                ...
                <div className="form-group formGroup mb-3">
                    ...
                    <input type="tel" maxLength={14} className="form-control formGroupTelefone" name="telefone"
                ...
                <div className="form-group formGroup mb-3">
                    <label>Email</label>
                    <input type="email" className="form-control formGroupEmail" name="email"
                ...
                <div className="form-group formGroup mb-3">
                    <label>Número</label>
                    <input type="text" className="form-control formGroupNumero" name="numero"
                ...
                <div className="form-group formGroup mb-3">
                    ...
                    <input type="text" className="form-control formGroupComplemento" name="complemento"
                ...
                <div className="form-group formGroup mb-3">
                    <label>CEP</label>
                    <input type="text" className="form-control formGroupCep" name="cep"
                        value={formData.cep}
                        onChange={handleChange}
                    />
                </div>
                ...
                <div className="form-group formGroup mb-3">
                    <label>Estado</label>
                    <input type="text" className="form-control formGroupEstado" name="estado"
                ...
                <div className="form-group formGroup mb-3">
                    <label>Bairro</label>
                    <input type="text" className="form-control formGroupBairro"name="bairro"
